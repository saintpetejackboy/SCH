...
$payload = [
    ...
    "data" => [
        ...
        "documents" => [
            [
                "url" => "https://stp-sales-tool.s3.us-west-2.amazonaws.com/projects/8024/attachments/v3ou2Gp5mCK89k7DNvcnGKBc1irvebFjF5i4avHi.png",
                "label" => "Design"
            ],
            [
                "url" => "https://stp-sales-tool.s3.us-west-2.amazonaws.com/proposals/46971/shadereports/shadereport-46971.pdf",
                "label" => "Shade Report"
            ],
            [
                "url" => "https://stp-sales-tool.s3.us-west-2.amazonaws.com/proposals/46971/productiongraphs/production-graph-46971.pdf",
                "label" => "Production Graph"
            ]
        ],
        "proposal_url" => "https://app.subcontractorhub.com/public-proposal/62918b59-69ef-47dc-b9b8-b594670225c6",
...
// Output the resulting JSON response
echo $response;
